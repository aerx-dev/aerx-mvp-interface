...
const TOKEN_CONTRACT_NAME = "a_token.mohzcrea8me.testnet"; //to manipulate aer tokens
...
//async function loadCNFTContract(nearState) {
    ...
    //console.log("newpnft contract:", cnftContract);
...
const nftChangeMethods = ["mint_profile", "nft_transfer"];
