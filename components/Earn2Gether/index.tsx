...
const Earn2Gether: React.FC = () => {
    ...
    const onPost = async() => {
        ...
        alert("Post to Save")
        alert(JSON.stringify(postToSave))
    }
    ...
    return (
        <div className='flex bg-[#1E2021] w-full rounded-[5px]'>
            <div className={`w-[50%] bg-[#1E2021]`}>
                ...
                {filePreview &&
                    <div className='bg-[#2C2F31] w-[100%] h-[40vh] flex justify-around items-center'>
                        <Image src={filePreview} alt="upload nft" width={340} height={315} className="w-full" />
                    </div>
                }
                <div className='p-4'>
            ...
            <div className='p-4 w-[50%]'>
                ...
                <div className='p-4'>
                    ...
                    <div className='flex flex-col'>
                        <label className='text-[14px] text-gray-500 mt-4'>Name:  {sharedPostMetaData?.title}</label>
